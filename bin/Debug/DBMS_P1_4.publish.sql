...
GO
PRINT N'Creating [dbo].[BillingAddress]...';
...
CREATE TABLE [dbo].[BillingAddress] (
    ...
    [State]   CHAR (2)      NULL,
    [Zipcode] INT           NULL,
    CONSTRAINT [PK_BillingAddress] PRIMARY KEY CLUSTERED ([UID] ASC)
);
...
GO
PRINT N'Creating [dbo].[FK_BillingAddress_User]...';


GO
ALTER TABLE [dbo].[BillingAddress]
    ADD CONSTRAINT [FK_BillingAddress_User] FOREIGN KEY ([UID]) REFERENCES [dbo].[User] ([UID]);
...
GO
PRINT N'Creating [dbo].[FK_Downloads_BillingAddress]...';


GO
ALTER TABLE [dbo].[Downloads]
    ADD CONSTRAINT [FK_Downloads_BillingAddress] FOREIGN KEY ([BillingAddress]) REFERENCES [dbo].[BillingAddress] ([UID]);
...
GO
PRINT N'Creating [dbo].[CK_BillingAddress_State]...';


GO
ALTER TABLE [dbo].[BillingAddress]
    ADD CONSTRAINT [CK_BillingAddress_State] CHECK (State IN('AL', 'AK', 'AZ', 'AR', 'CA', 'CO', 'CT', 'DE', 'FL', 'GA', 'HI', 'ID', 'IL', 'IN', 'IA', 'KS', 'KY', 'LA', 'ME', 'MD', 'MA', 'MI', 'MN', 'MS', 'MO', 'MT', 'NE', 'NV', 'NH', 'NJ', 'NM', 'NY', 'NC', 'ND', 'OH', 'OK', 'OR', 'PA', 'RI', 'SC', 'SD', 'TN', 'TX', 'UT', 'VT', 'VA', 'WA', 'WV', 'WI', 'WY'));


GO
PRINT N'Creating [dbo].[CK_BillingAddress_Zipcode]...';


GO
ALTER TABLE [dbo].[BillingAddress]
    ADD CONSTRAINT [CK_BillingAddress_Zipcode] CHECK (Zipcode BETWEEN 11111 AND 99999);
...
GO
PRINT N'Creating [dbo].[CK_Downloads_CICNum]...';


GO
ALTER TABLE [dbo].[Downloads]
    ADD CONSTRAINT [CK_Downloads_CICNum] CHECK (CICNum between 111 and 999);
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '895db730-033d-4654-8ed9-bb6dcb5ea851')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('895db730-033d-4654-8ed9-bb6dcb5ea851')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '09d51a02-4324-4e65-953c-a179ed19315c')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('09d51a02-4324-4e65-953c-a179ed19315c')
